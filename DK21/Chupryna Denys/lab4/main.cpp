...
int main(int argc, char* argv[])
{
    ...
    points2[0] = createPoint(-80, 0);
    points2[1] = createPoint(-30, 0);
    points2[2] = createPoint(-40, -60);
    figure2 = createFigure(points2, createColor(0.0, 1.0, 1.0));

    addFigToFigList(figlist, figure2);


    points3[0] = createPoint(-30, -70);
    points3[1] = createPoint(0, -40);
    points3[2] = createPoint(20, -80);
    figure3 = createFigure(points3, createColor(0.0, 1.0, 0.0));
    ...
    points4[0] = createPoint(-80, 0);
    points4[1] = createPoint(-30, 0);
    points4[2] = createPoint(-40, -60);
