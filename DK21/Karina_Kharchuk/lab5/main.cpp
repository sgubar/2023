...
void display()
{
    ...
    glBegin(GL_POLYGON); //основа піраміди (правильний трикутник)
        glColor3f(0.1f, 0.0f, 0.1f); //темно-фіолетовий
    ...
    glBegin(GL_TRIANGLES); //грані
        ...
        glColor3f(2.0f, 0.5f, 1.0f); //фіалковий
        glVertex3f(-1.0f, 0.0f, -1.0f);
        glVertex3f(1.0f, 0.0f, -1.0f);
        glVertex3f(0.0f, 1.0f, 0.0f);

        glColor3f(1.0f, 0.5f, 0.0f); //оранжевий
        glVertex3f(1.0f, 0.0f, -1.0f);
        glVertex3f(0.0f, 0.0f, 1.0f);
        glVertex3f(0.0f, 1.0f, 0.0f);

        glColor3f(0.5f, 1.0f, 0.5f); //зелений 
        glVertex3f(0.0f, 0.0f, -1.0f);
        glVertex3f(-1.0f, 0.0f, -1.0f);
        glVertex3f(0.0f, 1.0f, 0.0f);
