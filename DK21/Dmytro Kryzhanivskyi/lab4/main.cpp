...
int main(int argc, char* argv[])
{
    ...
    points1[0] = createPoint(40, -40);
    points1[1] = createPoint(-40, -40);
    points1[2] = createPoint(-40, 40);
    points1[3] = createPoint(40, 40);
    figure1 = createFigure(points1, createColor(1.0, 0.0, 1.0));

    addFigToFigList(figlist, figure1);

    points2[0] = createPoint(-30, 0);
    points2[1] = createPoint(-30, -30);
    points2[2] = createPoint(0, -30);
    points2[3] = createPoint(0, 0);
    figure2 = createFigure(points2, createColor(1.0, 1.0, 0.0));

    addFigToFigList(figlist, figure2);

    points3[0] = createPoint(20, 0);
    points3[1] = createPoint(20, -20);
    points3[2] = createPoint(40, -20);
    points3[3] = createPoint(40, 0);
    ...
    points4[0] = createPoint(-50, 0);
    points4[1] = createPoint(-50, 10);
    points4[2] = createPoint(-40, 10);
    points4[3] = createPoint(-40, 0);
